#mysqldump -u jack -p --compact --no-create-info --where="dv_id=15" cldl cldl_dv >> cldl_dv.sql
mysqldump -u jack -p --compact --no-create-info --where="dv_id=15" cldl cldl_dvf >> cldl_dvf.sql
#mysqldump -u jack -p --compact --no-create-info cldl cldl_menu > cldl_menu.sql
#mysqldump -u jack -p --compact --no-create-info cldl cldl_company > cldl_company.sql
#mysqldump -u jack -p --compact --no-create-info cldl cldl_user > cldl_user.sql
